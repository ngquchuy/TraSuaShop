...
import 'package:milktea_shop/controllers/user_controller.dart'; // <--- 1. Import User Controller
...
class OrderController extends GetxController {
  ...
  Future<bool> createOrder({
    ...
    try {
      ...
      // <--- 2. Lấy Token từ UserController để xác thực ---
      ...
      final response = await http.post(
        ...
        headers: headers, // Truyền headers đã có token
      ...
      if (response.statusCode == 201 || response.statusCode == 200) {
        ...
        // Lưu đơn hàng vào Firestore (Backup)
        ...
        Get.snackbar('Lỗi', 'Server từ chối: ${response.body}');
        return false;
      }
    } catch (e) {
  ...
  Stream<List<OrderModel>> getOrderHistoryStream() {
    ...
    return FirebaseFirestore.instance
        ...
        .map((snapshot) => snapshot.docs
            .map((doc) => OrderModel.fromJson(doc.data())) // Sửa lỗi cast map
            .toList());
  }
}
